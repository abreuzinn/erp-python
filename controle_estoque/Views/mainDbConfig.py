...
class Ui_ct_dbConf(object):
    ...
    def traddBConf(self, ct_dbConf):
        ct_dbConf.setWindowTitle(QtWidgets.QApplication.translate(
            "ct_dbConf", "Frame", None, -1))
        self.bt_SalvarConfigDB.setText(
            QtWidgets.QApplication.translate("ct_dbConf", "SALVAR", None, -1))
        self.lb_FormFornecedor_3.setText(QtWidgets.QApplication.translate(
            "ct_dbConf", "CONFIGURAÇÃO BANCO DE DADOS", None, -1))
        self.lb_FormFornecedor_25.setText(QtWidgets.QApplication.translate(
            "ct_dbConf", "ENDEREÇO IP SERVIDOR", None, -1))
        self.lb_FormFornecedor_46.setText(QtWidgets.QApplication.translate(
            "ct_dbConf", "NOME DO BANCO DE DADOS", None, -1))
        self.lb_FormFornecedor_47.setText(
            QtWidgets.QApplication.translate("ct_dbConf", "USUÁRIO", None, -1))
        self.tx_DbPass.setPlaceholderText(
            QtWidgets.QApplication.translate("ct_dbConf", "DB PASS", None, -1))
        self.lb_FormFornecedor_48.setText(
            QtWidgets.QApplication.translate("ct_dbConf", "SENHA ", None, -1))
        self.tx_DbUser.setPlaceholderText(
            QtWidgets.QApplication.translate("ct_dbConf", "DB USER", None, -1))
        self.tx_IpServer.setInputMask(QtWidgets.QApplication.translate(
            "ct_dbConf", "000.000.000.000", None, -1))
        self.tx_IpServer.setText(
            QtWidgets.QApplication.translate("ct_dbConf", "...", None, -1))
        self.tx_IpServer.setPlaceholderText(
            QtWidgets.QApplication.translate("ct_dbConf", "127.0.0.1", None, -1))
        self.tx_DbName.setPlaceholderText(
            QtWidgets.QApplication.translate("ct_dbConf", "DB NAME", None, -1))
        self.bt_TestarConexao.setText(
            QtWidgets.QApplication.translate("ct_dbConf", "TESTAR", None, -1))
